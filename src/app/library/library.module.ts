...
/**
 * Librairie de widgets esri 'socle'.
 * Ce sont des simple fenêtre avec un container dans lequel on insert le widget esri.
 *
 * Un widget 'plugin' est ce qui existe actuellement = un composant angular
